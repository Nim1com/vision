...
#if defined(NDEBUG)
# error "Vision cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x4be5445501cc2bf2dc16e8b8fa43aaef17f1de389d3743b3c676613634f0d785");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Vision: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Vision Signed Message:\n";
...
{
    // Vision: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 525000); // Vision: 525k blocks in ~1 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Vision: 1 day
static const int64 nTargetSpacing = 1 * 60; // Vision: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Vision: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::ConnectBlock(CValidationState &state, CBlockIndex* pindex, CCoinsViewCache &view, bool fJustCheck)
{
    ...
    // Do not allystore.o obj/main.o obj/net.o obj/protocol.o obj/bitcoinrpc.o obj/rpcdump.o obj/rpcnet.o obj/rpcmining.o obj/rpcwallet.o obj/rpcblockchain.o obj/rpcrawtransaction.o obj/script.o obj/scrypt.o obj/sync.o obj/util.o obj/wallet.o obj/walletdb.o obj/hash.o obj/bloom.o obj/noui.o obj/leveldb.o obj/txdb.o -Wl,-z,relro -Wl,-z,now   -Wl,-Bdynamic -l boost_system -l boost_filesystem -l boost_program_options -l boost_thread -l db_cxx -l ssl -l crypto -l miniupnpc -Wl,-Bdynamic -l z -l dl -l pthread /home/ubuntu/Desktop/vision/src/leveldb/libleveldb.a /home/ubuntu/Desktop/vision/src/leveldb/libmemenv.a ow blocks that contain transactions which 'overwrite' older transactions,
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Vision: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x38c5107e390a03d0d382edf86473da2b53d66b549d39b0231ab38628d02f11e8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "CNN 27/Jun/2022 Russia strikes mall with more than 1,000 peole inside, Zelensky says";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 150 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04144d36d4e32b5c02d85f3043de52278560f5b84fcf2a20178cf251aebf31f6eb90707cf23cfbceaeccb8adffaa7b97620788d9950aab225af139711b21e3a76f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1656337636;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085743810;

        if (fTestNet)
        {
            block.nTime    = 1656337614;
            block.nNonce   = 386319998;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xcc11b8fad4d0f9d5bc4dcede7a75b6b4bfe07e20741ceb25acbbe6cfc8799b39"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc1, 0xb7, 0xdc }; // Vision: increase each by adding 1 to litecoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VisionMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VisionMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static VisionMiner(CWallet *pwallet)
{
    printf("VisionMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("vision-miner");
    ...
    try { loop {
        ...
        printf("Running VisionMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&VisionMiner, pwallet));
}
